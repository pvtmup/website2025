...
window.LORE_DATA = {
  ...
  episodeTitles: [
    ...
    "Чужая роль","Первый враг","Слишком поздно","Право на корону","Один звонок",
    "Маска спадает","Вторая жизнь","Цена молчания","Игра на вылет","Не та сторона",
    "Поздний гость","Слово против слова","Конец перемирия","Кто-то лжёт","Возврата нет",
    "Имя на афише","Тот самый кадр",
  ],
  // персонализация: вплетаем «кем ты втайне хочешь быть» ({vibe})
  vibeOpens: [
    "{you} всегда хотел(а) одного — стать «{vibe}». Сегодня {world} это наконец заметил(а).",
    "«{vibe}» — так {you} описал(а) себя однажды. Доказывать пришлось при всех.",
    "{you} обещал(а) себе: «{vibe}». Никто не верил. Зря.",
    "Под маской {you} всё ещё жил(а) мечтой: «{vibe}». Этой ночью маска треснула.",
  ],
  ...
  opens: {
    star:    ["Весь {world} смотрел, когда {you} вошёл(ла) — и тебе это нравилось.",
              "Камеры, шёпот, вспышки. {you} владел(а) залом ещё до первого слова.",
              "Каждый в {world} хотел стоять рядом с тобой. Места хватило не всем."],
    rebel:   ["{you} не должен(на) был(а) быть здесь сегодня. В этом и был смысл.",
              "Правила созданы, чтобы их ломать, и {you} вёл(а) длинный список.",
              "{world} привык к тишине. {you} пришёл(ла) её закончить."],
    mystery: ["Никто в {world} не знал, кто {you} на самом деле. От этого все тянулись ближе.",
              "{you} прятал(а) по одной тайне за каждой улыбкой. Сегодня одна выскользнула.",
              "{you} оброс(ла) тремя легендами. Все три врали."],
    lover:   ["Двое хотели тебя сегодня. Разбить сердце {you} мог(ла) только одному.",
              "{you} клялся(ась) больше не влюбляться. У {world} были другие планы.",
              "Один взгляд через зал — и {you} понял(а), что вечер уже не спасти."],
    trickster:["{you} запустил(а) всё это просто чтобы посмотреть, что будет.",
              "У хаоса в {world} есть любимчик, и сегодня этот любимчик — {you}.",
              "{you} соврал(а) троим за вечер. Двое уже знали. Третий — нет."],
    underdog:["Тебя списали в прошлом сезоне. Сейчас уже никто не смеялся.",
              "Терять тебе было нечего — а в {world} это делало тебя опасным(ой).",
              "Все ставили против тебя. {you} запомнил(а) каждого."],
  },
  ...
  beats: {
    ally:   ["{co} отвёл(ла) {you} в сторону. «Что бы ни случилось дальше — я с тобой. Не подведи.»",
             ...
             "{co} молча встал(а) за спиной {you}. Иногда это говорит громче слов."],
    rival:  ["{co} улыбнулся(ась) так, как умеют только враги. «Наслаждайся вечером. Он последний, что ты выиграл(а).»",
             ...
             "«У тебя ровно один ход, — сказал(а) {co}. — И я уже знаю какой.»"],
    love:   ["{co} подошёл(ла) так близко, что {you} забыл(а) про весь остальной {world}.",
             ...
             "«Все смотрят», — сказал(а) {co}. «Пусть смотрят», — ответил(а) {you}."],
    secret: ["{co} знал(а). {you} это видел(а). Вопрос был только в цене молчания.",
             ...
             "{co} наклонился(ась) к уху {you}: «Я знаю, где ты был(а) той ночью.»"],
  },
  ...
  solo: ["Телефон {you} зажёгся сообщением с номера без имени.",
         ...
         "В {world} вырубился свет. В темноте кто-то взял {you} за руку.",
         "На стене висел постер сегодняшнего вечера. С лицом {you}, которого {you} не утверждал(а)."],
  ...
  cliffs: ["И тут двери распахнулись — и вошёл тот, кого {you} считал(а) ушедшим навсегда.",
           ...
           "«Нам надо поговорить», — и {you} понял(а), что эти слова сегодня прозвучат дважды.",
           "Где-то в зале щёлкнул затвор камеры. {you} ещё не знал(а), кому достанется этот кадр.",
           "Часы пробили полночь. По плану {you} уже должен(на) был(а) исчезнуть."],
  ...
  // EPISODE DROP — лимитированные тематические события (ротация по неделям)
  drops: [
    { id:"halloween", emoji:"🎃", name:"Хэллоуин-академия", desc:"Маски, проклятия и один выживший к финалу.", g:["#3a1255","#0a0a0f"] },
    { id:"island",    emoji:"🏝️", name:"Реалити-остров",    desc:"Жара, альянсы и голосования на вылет.",       g:["#0d3a4b","#07242e"] },
    { id:"noir",      emoji:"🕵️", name:"Нуар-детектив",     desc:"Дождь, виски и труп уже в первом акте.",       g:["#1a1a22","#05050a"] },
    { id:"prom",      emoji:"👑", name:"Королевский бал",    desc:"Короны, интриги и один танец, что решает всё.",  g:["#2a0a1f","#5e1239"] },
  ],
  // батл-пасс трек: порог очков → награда (premium = только для LORE+)
  dropTrack: [
    { at:60,   title:"Участник дропа",     premium:false },
    { at:180,  title:"Восходящая звезда",  premium:false },
    { at:360,  title:"Икона события",      premium:true  },
    { at:600,  title:"Лицо дропа",         premium:false },
    { at:900,  title:"Легенда события",    premium:true  },
    { at:1300, title:"VIP дропа",          premium:true  },
  ],
